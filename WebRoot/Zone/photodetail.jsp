...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>您好，欢迎来到952116综合信息门户网!他人空间-照片详情</title>
    ...
    <div class="mainbody_1">
	    ...
	    <div class="uuop">
	      ...
	      <div class="right">
	        ...
	        <div class="lujin"> <a href="Zone/albumList.action?TTid=${TTid }">他的相册</a> > <a href="Zone/photoOfAlbum.action?albumid=${album.albumid }&TTid=${TTid }">${album.albumname }</a> > <b>${result.content[0].photoname }</b> </div>
	        <div class="poth_1">
	          <ul>
	        ...
	        <div class="poth_5">
	        <form action="Zone/photoDetail.action" method="post" id="formphoto">
	        ...
	        <div class="poth_1 mari">
	          <ul>
	            <li class="tm" id="commnum"><b>相册评论(共${fn:length(photoComList)}条)</b><a name="Aname" id="Aid"></a></li>
	          </ul>
	        </div>
	        <div class="poth_4">
