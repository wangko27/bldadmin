...
<html>
	...
	<body>
					...
					<div class="list_5">
						...
						<c:forEach items="${schools}" varStatus="num" var="sch">
							...
							<li>
								<p>
									<a
										href="<%=basePath%>learn/teacherbema_showSchool.action?articlesrcId=${sch.articlesrcid }"><img
											src="<%=basePath%>${sch.albumspath }/cover.jpg" width="100"
											height="120" /> </a>
								</p>
								<p>
									<a
										href="<%=basePath%>learn/teacherbema_showSchool.action?articlesrcId=${sch.articlesrcid }">${sch.schoolname
										}</a>
								</p>
							</li>
							<c:if test="${num.index%4==33}">
								</ul>
							</c:if>
						</c:forEach>
					</div>
		...
		<jsp:include page="/base/bottom.jsp"></jsp:include>55555
	</body>
</html>
