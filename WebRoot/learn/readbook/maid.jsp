...
<script type="" >
			...
			$().ready(function(){
				...
				$("#a_collect").bind("click",function(){
					...
					$.ajax({
						type:"post",
						url:"learn/PerusalArticle!collect.action",
						data:{articlesrcid:articlesrcid},
						dataType:"text",
						success:function(msg){
							if(msg==1){
...
<div class="mainbody">
  <div class="seat"><a href="#">952116综合信息门户网首页</a> > <a href="learn/xx_index.action">学习频道</a> > <span><s:property value="articleSrc.articletitle" /></span></div>
</div>
<div class="mainbody">
  <div class="listbig">
    <div class="listleft">
      <div class="maind_1"><s:property value="articleSrc.articletitle" /></div>
      <div class="maind_2"><span class="s1"><fmt:formatDate value="${articleSrc.createdate}" pattern="yyyy-MM-dd"/></span> <span class="s2">
      
      
      <a href="#" id="a_share"><img src="../img/learning_img/fen_1.gif" /></a><s:property value="articleSrc.sharenum" /></span>
       <span class="s3"><a href="#"  id="a_collect"><img src="../img/learning_img/fen_2.gif" /></a><s:property value="articleSrc.collectionnum" /></span></div>
      <div class="maind_3">
      ...
      <div class="maind_4">
        <ul>
          ...
          <li><a href="<%=basePath %>learn/getArticleById.action?id=${row.articlesrcid}">${row.articletitle}</a> <span><fmt:formatDate value="${row.createdate}" pattern="yyyy-MM-dd"/></span></li>
          </s:iterator>      
        </ul>
      </div>
    </div>
