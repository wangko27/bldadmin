...
<div class="mainbody">
  <div class="shbiglist">
    ...
    <div class="listright">
      <div class="sskl"><a href="shopping/shpping_showShopList.action?byTopicId=&t=1&byMainTopicId=">全部商品</a>
      ...
      <div class="stytu">
        ...
        <c:choose>
      	...
      	<c:otherwise>
			<form id="form1" action="shopping/shpping_showNewGoods.action" method="post">
