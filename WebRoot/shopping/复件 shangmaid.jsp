        ...
        <div class="cebb">
          ...
          <ul class="kuai">
            ...
            <li class="ddu"><a href="#" onclick="return buy('${goods.goodsid }')"><img src="<%=basePath%>img/shopping_img/gg.gif" /></a>
			 <a href="#?goodsid=${goods.goodsid }" onclick="return false"><img id="ffPic" src="<%=basePath%>img/shopping_img/ff.gif" /></a></li>
		  ...
		  <ul class="kuai">
            ...
            <li class="ddu"><a href="#"><img src="img/shopping_img/gg.gif" /></a> </li>
          </ul>
          <ul class="liang">
            <li>想购买人数：<span>已有<b>2283人</b>想购买</span></li>
          </ul>
...
<div class="mainbody">
  <div class="commondi"><a href="#">数字化校园系统</a> | <a href="#">技术服务</a> | <a href="#">友情链接</a> | <a href="#">网站导航</a> | <a href="#">广告服务</a> | <a href="#">合作伙伴</a> | <a href="#">帮助中心</a><span><a name="aa" id="aa"></a><a href="javascript:scroll(0,0)"><img src="<%=basePath%>img/learning_img/fan.gif" /></a></span></div>
