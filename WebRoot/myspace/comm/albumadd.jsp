...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>您好，欢迎来到952116综合信息门户网!用户中心-添加相册</title>
    ...
    <div class="mainbody_1">
	    ...
	    <div class="uuop">
	      ...
	      <div class="right">
	        ...
	        <form action="myspace/comm/albumAdd.action" id="form1" method="post">
	        <s:token></s:token>
		        <div class="bobti">我的相册</div>
		        <div class="lujin"> <a href="myspace/comm/albumList.action">我的相册</a> > <b>创建相册</b> </div>
		        <div class="poth_1">
		          <ul>
		            <li class="tm"><b>填写相册信息</b> </li>
		          </ul>
		        </div>
		        <div class="poth_6">
		        	<ul>
		            	<li>相册名称：<input id="album.albumname" name="album.albumname" type="text" /></li>
		                <li>相册信息：<textarea id="album.albumnotes" name="album.albumnotes" cols="" rows=""></textarea></li>
						<li>谁能访问：
							<select name="album.viewperm">
								<option value="1">所有人</option>
								<option value="2">所有好友</option>
								<option value="3">仅主人</option>
							</select>
						</li>
