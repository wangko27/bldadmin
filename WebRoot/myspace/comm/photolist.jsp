...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>您好，欢迎来到952116综合信息门户网!用户中心-照片列表</title>
    ...
    <div class="mainbody_1">
	    ...
	    <div class="uuop">
	      ...
	      <div class="right">
	        ...
	        <div class="lujin"> <a href="myspace/comm/albumList.action">我的相册</a> > <b>${album.albumname }</b> </div>
	        <div class="poth_1">
	          <ul>
	            <li class="tm"><b>${album.albumname }</b> (共${album.photonum }张)</li>
	            <s:if test="album.isdefault==0 ">
	            <li class="rr"><a href="myspace/comm/albumEditUp.action?albumid=${album.albumid }">编辑</a> | <a href="myspace/comm/albumDel.action?albumid=${album.albumid }">删除</a></li>
	          	</s:if>
	          </ul>
	        </div>
	        <form id="formphoto" action="myspace/comm/photoDetail.action" method="post">
			...
			<form id="formpage" action="myspace/comm/photoOfAlbum.action"  method="post">
