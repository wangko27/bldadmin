...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>您好，欢迎来到952116综合信息门户网!用户中心-问题管理</title>
	      ...
	      <div class="right">
	        ...
	        <div class="queslist">
	          <table width="200" border="0" cellspacing="0" cellpadding="0">
 			  ...
 			  <s:iterator value="questionList" status="st" id = "que">
	            <tr>
	              <td class="k1"><a href="Article/getQuestionById.action?id=${questionid}">
	                <c:choose>
	           		<c:when test="${fn:length(question)<35}">${question }</c:when>
	           		<c:otherwise>${fn:substring(question,0,33)}...</c:otherwise> 
	           		</c:choose>
	              </a></td>
	              <td class="k2">${answernum }</td>
	              <td class="k2">
	              <img <s:if test='questionstatus == "1"'>src="img/news_img/yidahh.gif"</s:if><s:else>src="img/news_img/wenhh.gif"</s:else> width="22" height="21" />
	              </td>
