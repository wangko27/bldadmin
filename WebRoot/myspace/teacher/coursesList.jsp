		...
		$().ready(function(){
			...
			$("#gradeId").change(function(){
				...
				if(gradeId == 0){
					...
					$("#classId").append("<option value='0'>没有班级</option>");
				}else{
					$("#courseTeaForm").attr("action","<%=basePath%>member/courseAction!onchageGradeBytea.action");
					$("#courseTeaForm").submit();
				}
			});
			...
			$("#classId").change(function(){
				...
				if(classId != '0'){
					$("#courseTeaForm").attr("action","<%=basePath%>member/courseAction!getCourseByTea.action");
					$("#courseTeaForm").submit();
				}
			});
		});
	   ...
	   <div class="right">
        ...
        <div class="dtai">
          <ul>
            ...
            <li class="bai"><a href="member/courseAction!getCourseByTea.action">课程表查询</a></li>
          </ul>
        </div>
        <form method="post" id="courseTeaForm">
        <div class="xunc_1">
        ...
        <div class="xunc_2">
          <h1><span>查询结果：</span>（${requestScope.gradeName} + ${requestScope.className}）</h1>
