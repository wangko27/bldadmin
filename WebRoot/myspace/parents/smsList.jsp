	...
	<script type="text/javascript">
		$().ready(function(){
			...
			$("#smsQueryBtn").mouseover(function(){
				...
				$("#smsQueryForm").attr("action","<%=basePath%>member/smsMsgAction!parQuery.action");
				$("#smsQueryForm").submit();
			});
		});
	 ...
	 <div class="right">
        ...
        <div class="dtai">
          <ul>
            ...
            <li class="bai"><a href="member/smsMsgAction!parQuery.action">短信查询</a></li>
            <li><a href="member/courseAction!getCourseByPar.action">课程表查询</a></li>
          </ul>
        </div>
        <form action="<%=basePath%>member/smsMsgAction!parQuery.action" method="post" id="smsQueryForm">
        <div class="xunc_1">
        ...
        <div class="xunc_2">
          <h1><span>查询结果：</span>（${requestScope.startDate} --- ${requestScope.endDate}）您的孩子短信如下  (含作业、个性、成绩等短信)</h1>
          <table width="720" border="0" cellspacing="0" cellpadding="0" >
          	<tr>
              <td class="t1" width="12%">短信类别</td>
              <td class="t1" width="12%">孩子姓名</td>
