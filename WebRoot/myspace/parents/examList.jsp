...
<html>
  <head>
    ...
    <title>您好，欢迎来到952116综合信息门户网952116综合信息门户网！-- 成绩查询</title>
	...
	<link href="<%=basePath%>css/user/chaxun.css" rel="stylesheet" type="text/css" />
 	...
 	<script type="text/javascript">
 		$().ready(function(){
 			...
 			$("#parQueryBtn").mouseover(function(){
 				...
 				if(displayType == '1'){
 					...
 					stuId =  $("input[name='stuId']:checked").val();
 				}
 				 
 				$.ajax({
 					type:"post",
 					url:"<%=basePath%>member/examQueryAction!getStuExamByParent.action",
 					data:{stuId:stuId, examId:examId, examName:examName, termName:termName, examDateId:examDateId, examDate:examDate },
 					success:function(data){
 						if(data == 'exception'){
 							alert("查询出错！");
 							return ;
 			...
 			//学生单选按钮
 			$("#stuQueryForm :radio").click(function(){
 				$("#stuQueryForm").attr("action","<%=basePath%>member/examQueryAction!getExamListChangeStuId.action");
 				$("#stuQueryForm").submit();	
 			});
  ...
  <div class="dde">
	...
	<jsp:include page="../content_leftmenu.jsp"></jsp:include>
	 <div class="right">
        ...
        <div class="dtai">
          <ul>
            <li class="bai"><a href="member/examQueryAction!parExamList.action">成绩查询</a></li>
            ...
            <li><a href="member/courseAction!getCourseByPar.action">课程表查询</a></li>
          </ul>
        </div>
        ...
        <div class="xunc_1">
          <table width="700" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td><input name="parQueryBtn"  id="parQueryBtn" type="button"  class="cx"/></td>
            </tr>
          </table>
        </div>
        </form>
