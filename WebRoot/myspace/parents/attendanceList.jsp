	...
	<script type="text/javascript">
		$().ready(function(){
			...
			$("#attenQueryBtn").mouseover(function(){
				...
				$("#attenQueryForm").attr("action","<%=basePath%>member/attenQueryAction!parAttendancePager.action");
				$("#attenQueryForm").submit();
			});
			
			
			//学生单选按钮
 			$("#attenQueryForm :radio").click(function(){
 				$("#attenQueryForm").attr("action","<%=basePath%>member/attenQueryAction!parAttendancePager.action");
 				$("#attenQueryForm").submit();	
 			});
		});
	 ...
	 <div class="right">
        ...
        <div class="dtai">
          <ul>
            ...
            <li class="bai"><a href="member/attenQueryAction!parAttendancePager.action">考勤查询</a></li>
            <li><a href="member/smsMsgAction!parQuery.action">短信查询</a></li>
            <li><a href="member/courseAction!getCourseByPar.action">课程表查询</a></li>
          </ul>
        </div>
        <form action="<%=basePath%>member/attenQueryAction!parAttendancePager.action" method="post" id="attenQueryForm">
        <div class="xunc_1">
        ...
        <div class="xunc_2">
          <h1><span>查询结果：</span>（${requestScope.startDate} --- ${requestScope.endDate}）您的孩子考勤记录如下</h1>
