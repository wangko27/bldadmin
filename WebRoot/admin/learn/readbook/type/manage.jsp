...
<html>
	...
	<body>
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<s:iterator value="#request.list_readType" id="readType">
				<tr align="center" bgcolor="#FFFFFF"
					onMouseMove="javascript:this.bgColor='#e8f6ff';"
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					<td>
						<u>${readType.srctype }</u>
					</td>
					<td>
						<u>${readType.readSrcType.srctype } </u>
					</td>
					<td>
					...
					<td>
						<a
							href="admin/learn/readType!updatePage.action?srctypeid=${readType.srctypeid }">修改</a>&nbsp;
						|&nbsp;
						<a
							href="admin/learn/readType!delete.action?srctypeid=${readType.srctypeid }"
			...
			<tr bgcolor="#e8f6ff">
				<td class="nv" colspan="5">
					<form id="form1" action="admin/learn/readType!manage.action" method="post">
					</form>
