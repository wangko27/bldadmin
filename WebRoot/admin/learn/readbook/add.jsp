...
<html>
		...
		<script type="text/javascript">
			...
			$().ready(function() {
				...
				$.validator.methods.check_resource = function(value, element, param){
					if(value!=""){   
					    //验证上传文件类型
						var allowFileType = "DOC,TXT,XLS,PDF,RAR,ZIP,JPG,GIF,PNG,BMP";
				...
				$("#formReadBookAdd").validate({
					//验证规则
					rules:{
						readsrctile:"required",
						'readSrcType.srctypeid':"required",
					...
					messages:{
						...
						resource:{
							check_resource:"资源只能上传DOC,TXT,XLS,PDF,RAR,ZIP,JPG,GIF,PNG,BMP格式的文件!"
						},
						downpoint:{
							required:"下载所需积分不能为空!",
							number:"下载所需积分只能为整数!"
	...
	<body>
		...
		<form method="post" action="admin/learn/addReadBook.action"
			name="formReadBookAdd" id="formReadBookAdd"
					...
					<td height="26" background="skin/images/newlinebg3.gif">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td style="word-break: break-all">
									<input type="file" name="resource" id="resource" size="30">
									<br />
									课件只能上传DOC、TXT、XLS、PDF(最大1M)，JPG、GIF、PNG、BMP(最大2M)，RAR、ZIP(最大10M)格式的
									<br />
									下载所需积分：
