...
<html>
	...
	<body>
		...
		<form method="post" action="admin/learn/addTeacherArticle.action"
					...
					<td height="26" background="skin/images/newlinebg3.gif">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr id="addarea">
								...
								<td>
									<input type="radio" name="flag" id="flag" value="1"/>图片+文字
									<input type="radio" name="flag" id="flag" value="2"/>视频+文字
									<input type="radio" name="flag" id="flag" value="3"/>文字
								</td>
							</tr>
							<tr id="addarea">
								<td align="left" width="100">
							...
							<tr>
								<td colspan="2" align="center">
									...
									<a href="admin/learn/teacherArticle!openTeacherArticle.action?superTeacherID=${superTeacherID }&username=${username }" target="main">返回文章管理</a>
								</td>
							</tr>
						</table>
					</td>
