...
<html>
	<head>
		...
		<title>学习频道管理——名师讲坛——名师信息修改</title>
		...
		<script type="text/javascript">
			...
			$().ready(function() {
				...
				$("#formSuperTeacherUpdate").validate({
					//验证规则
					rules:{
						username:"required",
	...
	<body>
		...
		<form method="post" action="admin/learn/updateSuperTeacher.action"
			name="formSuperTeacherUpdate" id="formSuperTeacherUpdate"
			enctype="multipart/form-data">
			<s:token></s:token>
			<input type="hidden" name="superTeacherID" id="superTeacherID" value="${superTeacher.superTeacherID }"/>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr id="addarea">
								<td align="left" colspan="2">
									<img src="${superTeacher.teacherPath }" width="149" height="187">
								</td>
							</tr>
							<tr id="addarea">
								...
								<td>
									<input type="text" name="username" id="username" size="50"
										maxlength="10" value="${superTeacher.username }">
									最多10个字
								</td>
							</tr>
							<tr id="addarea">
								...
								<td>
									<input type="text" name="teacherPost" id="teacherPost"
										size="50" maxlength="30" value="${superTeacher.teacherPost }">
									最多30个字
								</td>
							</tr>
							<tr>
								...
								<td style="word-break: break-all">
									<input type="text" name="inSchool" id="inSchool" size="50"
										maxlength="40" value="${superTeacher.inSchool }">
									最多40个字
								</td>
							</tr>
							<tr>
								...
								<td style="word-break: break-all">
									<input type="text" name="workyears" id="workyears" size="50" value="${superTeacher.workyears }"> 年
								</td>
							</tr>
							<tr>
								<td>
								...
								<td style="word-break: break-all">
									<s:radio list="#{1:'在职',0:'不在职'}" value="#request.superTeacher.flag" name="flag" id="flag"></s:radio>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td style="word-break: break-all">
									<textarea rows="3" cols="50" name="teaching_linian"
										id="teaching_linian">${superTeacher.teaching_linian }</textarea>
									最多512个字符
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td style="word-break: break-all" colspan="2">
									<textarea cols="80" id="teacherIntroduction"
										name="teacherIntroduction" rows="10">${superTeacher.teacherIntroduction }</textarea>
