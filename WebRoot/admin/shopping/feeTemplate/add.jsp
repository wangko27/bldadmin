...
<div class="maindiv">
    <h1>
        商品频道管理&mdash;&mdash;添加运费模板
    </h1>
</div>
<form action="<%=basePath %>admin/feeTemplate/addFeeTemplate.action" method="post" enctype="multipart/form-data"
      id="form_gAdd">
    <s:token></s:token>
        ...
        <tr>
            <td height="26" background="skin/images/newlinebg3.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>模板名称:<input name="fee.templateName" id="templateName"/></td>
                    </tr>
                    <tr>
                        ...
                        <%--</td>--%>
                        <td>
                            优惠价格:<input name="fee.price" id="price"/>元
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <%--</select>--%>
                            <%--之间--%>
                            首&nbsp;重&nbsp;量:<input name="fee.firstWeight" id="firstWeight"/>
                                <select name="fee.firstWeightUnit">
                                    <option value="g" selected> 克</option>
                                    <option value="kg">千克</option>
                                </select>
                    ...
                    <tr id="priceTr">
                        <td>首&nbsp;运&nbsp;费:<input id="firstPrice" name="fee.firstPrice"/>元</td>
                    </tr>
                    <tr>
                        <td>续重，则按照每<input name="fee.continueWeight" id="continueWeight"/>
                            <select name="fee.continueWeightUnit" id="continueWeightUnit">
                                <option value="g" selected> 克</option>
                                <option value="kg">千克</option>
                             </select>
                            收取<input name="fee.continuePrice" id="continuePrice"/>元的运送费用</td>
                    </tr>
