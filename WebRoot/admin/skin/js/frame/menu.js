...
function showHide(objname)
{
	...
	if(obj.style.display == 'block' || obj.style.display ==''){
		window.event.srcElement.style.background = "url(admin/skin/images/frame/menubg.gif)";
	}
	else{
		window.event.srcElement.style.background = "url(admin/skin/images/frame/menubg_1.gif)";
	}
