...
<html>
	...
	<body>
		<div class="maindiv">
			<h1>
				兴趣频道管理&mdash;&mdash;修改活动类别
			</h1>
		</div>
		<form method="post" action="admin/UpdateActivityType.action"
			name="form_activityTypeUpdate" id="form_activityTypeUpdate">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<select name="programa.proID" id="programa.proID">
										...
										<s:iterator value="programaAll" id="p">
											<option value="${p.proID }"
												<s:if test="#p==#request.activityType.programa">selected</s:if>>
												${p.proName }
											</option>
										</s:iterator>
									</select>
							...
							<tr>
								<td colspan="2" align="center">
									<input type="submit" name="Submit" value="修改" class="sst">
