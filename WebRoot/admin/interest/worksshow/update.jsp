...
<html>
	...
	<body>
		<div class="maindiv">
			<h1>
				兴趣频道管理&mdash;&mdash;修改首页活动作品展示
			</h1>
		</div>
		<form method="post" action="admin/UpdateWorksShow.action"
			name="form_worksShowUpdate" id="form_worksShowUpdate"
			enctype="multipart/form-data">
			<input type="hidden" name="showId" id="showId" value="${activityWorksShow.showId }" />
			<s:token></s:token>
					...
					<td height="26" background="skin/images/newlinebg3.gif">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<input type="text" name="showTitle" id="showTitle" size="50" value="${activityWorksShow.showTitle }" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="showUrl" id="showUrl" size="50" value="${activityWorksShow.showUrl }" />
								</td>
							</tr>
							<tr>
								<td align="left" width="150">
								...
								<td>
									<input type="text" name="showSort" id="showSort" value="0" value="${activityWorksShow.showSort }" />
								</td>
							</tr>
							<tr>
								<td align="left" width="150">
							...
							<tr>
								...
								<td>
									<s:radio list="#{1:'有效',0:'无效'}" value="%{#request.activityWorksShow.showEnabled}" name="showEnabled"></s:radio>
								</td>
							</tr>
							<tr>
