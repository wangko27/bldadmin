...
<html>
	...
	<body>
		...
		<form method="post" action="admin/updateMastersArticle.action"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr id="addarea">
								...
								<td>
									<input type="text" name="articletitle" id="articletitle"
										size="50" maxlength="256" value="${articleSrc.articletitle }">
									最多256个字符
								</td>
							</tr>
							<tr>
								...
								<td style="word-break: break-all">
									<input type="text" name="metakeywords" id="metakeywords"
										size="50" maxlength="128" value="${articleSrc.metakeywords }">
									多个以空格分隔，最多128个字符
								</td>
							</tr>
							<tr>
								...
								<td style="word-break: break-all">
									<s:radio list="#{0:'否',1:'是'}"
										value="#request.articleSrc.isrecommend" name="isrecommend"
										id="isrecommend"></s:radio>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td style="word-break: break-all">
									<s:radio list="#{0:'否',1:'是'}"
										value="#request.articleSrc.istop" name="istop" id="istop"></s:radio>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td style="word-break: break-all">
									<s:radio list="#{0:'否',1:'是'}"
										value="#request.articleSrc.ispublication" name="ispublication"
										id="ispublication"></s:radio>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td colspan="2" align="center">
									...
									<a
										href="admin/article!openMastersArticle.action?memberid=${memberid }&nikename=${nikename }"
