...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function loadselecttype(typeid){
				$.ajax({
					type:"post",
					url:"admin/articleType!loadArticleTypeOption.action",
					data:{
						articletypeid:typeid
					},
					dataType:"text",
	...
	<body
		onload="loadselecttype('${articleSrc.articleType.articletypeid }')">
		<div class="maindiv">
			<h1>
				资讯频道管理——修改文章
			</h1>
		</div>
		<form method="post" action="admin/updateArticle.action"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="left" colspan="2">
									<img src="${articleSrc.coverpath }" width="121" height="81"/>
								</td>
							</tr>
							<tr id="addarea">
								...
								<td>
									<input type="text" name="articletitle" id="articletitle"
										size="50" value="${articleSrc.articletitle }" maxlength="30">
									最大30个字	
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="word-break: break-all">
									<input type="text" name="metakeywords" id="metakeywords"
										size="30" value="${articleSrc.metakeywords }" maxlength="60">
									最大60个字，多个以空格分隔	
								</td>
							</tr>
							<tr>
								...
								<td style="word-break: break-all">
									<input type="text" name="artfrom" id="artfrom" size="30"
										maxlength="30" value="${articleSrc.artfrom }">
									最大30个字
								</td>
							</tr>
							<tr>
