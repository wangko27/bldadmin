...
keel.UploadPanel = function(cfg){
	...
	this.setting = {
        ...
        file_upload_limit : this.filenum||"0",  //限定用户一次性最多上传多少个文件，在上传过程中，该数字会累加，如果设置为“0”，则表示没有限制 
	...
	keel.UploadPanel.superclass.constructor.call(this,{				
		tbar : [
			...
			{text:'移出所有',ref:'../deleteBtn',iconCls:'delete2',handler:this.deleteAll,scope:this},'-'
		],
		layout : 'fit',
		items : [this.gp],
		listeners : {
...
Ext.extend(keel.UploadPanel,Ext.Panel,{
	...
	formatDelBtn : function(v){
		return "<a href='javascript:;' id='"+v+"'  style='color:blue' class='link-btn' ext:qtip='移出该文件'>移出</a>";
	},
