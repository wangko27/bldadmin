...
<div class="mainbody">
  <div class="seat"><a href="#">952116综合信息门户网首页</a> > <a href="interest/XQ_index.action">兴趣</a> >	<span>往期回顾列表</span></div>
</div>
<div class="mainbody">
  <div class="listbig">
    <div class="listleft">
      	...
      	<c:choose>
            ...
            <c:forEach items="${actList}" var="act" varStatus="vs"> 
   			 ...
   			 <ul>
   			 	...
   			 	<li>
   			 	<p>
   			 	<a href="interest/works_showActionWorks.action?activitId=${act.activityid}&activitPro=${act.programa.proID }">
   			 	${act.activitytitle }
   			 	</a>
   			 	</p>
   			 	<span>
   			 	<fmt:formatDate value="${act.enddate}" pattern="yyyy-MM-dd"/>
   			 	</span>
   			 	</li>
